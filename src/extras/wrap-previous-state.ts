 ...
 */
export function wrapPreviousState<V, R>(f: (newValue: V, oldValue?: V) => R): (value: V) => R;
 ...
 */
export function wrapPreviousState<V, R>(f: (newValue: V, oldValue: V) => R, init: V): (value: V) => R;

export function wrapPreviousState<C, V, R>(f: (this: C, newValue: V, oldValue: V | undefined) => R, init?: V): (this: C, value: V) => R {
    let oldValue = init;
